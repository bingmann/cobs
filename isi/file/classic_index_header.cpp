...
namespace isi::file {
    ...
    classic_index_header::classic_index_header() {}

    classic_index_header::classic_index_header(uint64_t signature_size, uint64_t block_size, uint64_t num_hashes, const std::vector<std::string>& file_names)
